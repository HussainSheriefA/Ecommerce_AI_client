...
Production-ready configuration with MySQL, Redis, Celery, and JWT authentication.
"""
import os
...
# =============================================================================
# DATABASE (SQLite for local, PostgreSQL for Railway/Render)
# =============================================================================
# Check if Railway/Render provides DATABASE_URL (PostgreSQL)
...
# CACHE (Redis)
# =============================================================================
# Temporarily using local memory cache - Redis not running locally
CACHES = {
    'default': {
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'eCommerce API',
    'DESCRIPTION': 'Production-ready eCommerce API with Django REST Framework',
    'VERSION': '1.0.0',
